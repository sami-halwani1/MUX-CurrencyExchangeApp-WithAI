	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			case 4: 
				...
				currency.RunIterations(currency);
				break;
			...
			for (int row = 0; row < 16; row++)
			{
				for (int col = 0; col < 16; col++)
				{
					...
					else
					{
						...
						System.out.print("{"+ dtf4.format(co+5
						+
						'5.6+5
						
						6+35 65nversionTable[row-1][col-1]) + "}, ");
					}
